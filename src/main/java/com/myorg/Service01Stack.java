...
public class Service01Stack extends Stack {
    ...
    public Service01Stack(final Construct scope, final String id, Cluster cluster, SnsTopic topic,
        ...
        this(scope, id, null, cluster, topic, invoiceBucket, invoiceQueue);
    }

    public Service01Stack(final Construct scope, final String id,
                          final StackProps props, Cluster cluster, SnsTopic topic,
                          Bucket invoiceBucket, Queue invoiceQueue) {
        ...
        ApplicationLoadBalancedFargateService service01 = ApplicationLoadBalancedFargateService.Builder
                ...
                .taskImageOptions(
                        ApplicationLoadBalancedTaskImageOptions.builder()
                                ...
                                .image(ContainerImage.fromRegistry("marconefreitas/curso_aws_project:1.0.9"))
                                .containerPort(8080)
        ...
        topic.getTopic().grantPublish(service01.getTaskDefinition().getTaskRole());
